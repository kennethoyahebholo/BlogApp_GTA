<template>
      ...
      <article class="testimonial">
         ...
         <article>
            ...
            <p>
               ...
               background
               color of an element with the color and background properties.
            </p>
            <section class="right_sub_section">
               <p>8 Min Read</p>
      ...
      <article class="testimonial">
         ...
         <article>
            ...
            <p>
               ...
               --prefix,
               and there are no real rules about their value.
            </p>
            <section class="right_sub_section">
               <p>10 Min Read</p>
   ...
   <article>
    ...
    <p>
     The CSS Grid Layout Module offers a grid-based layout system, with rows and columns, making it easier to design web
     pages without having to use floats and positioning.
    </p>
    <section class="right_sub_section">
     <p>3 Min Read</p>
   ...
   <article>
    ...
    <p>
     Colors play a vital role in making a web page usable or not. In Css, we can control the foreground and background
     color of an element with the color and background properties.
    </p>
    <section class="right_sub_section">
     <p>8 Min Read</p>
   ...
   <article>
    ...
    <p>
     CSS variables are custom properties that cascade normally and even inherit. They start with a reserved --prefix,
     and there are no real rules about their value.
    </p>
    <section class="right_sub_section">
     <p>10 Min Read</p>
